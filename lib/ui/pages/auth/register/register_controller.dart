...
class RegisterController {
  ...
  createUser(String email, String password, String sex, String username,
      int years, BuildContext context) async {
    try {
      await Auth().createUserWithEmailAndPassword(email, password).then((_) {
